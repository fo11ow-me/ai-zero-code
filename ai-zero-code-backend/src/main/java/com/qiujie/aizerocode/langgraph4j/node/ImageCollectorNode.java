...
import com.qiujie.aizerocode.langgraph4j.ai.ImageCollectionPlanService;
import com.qiujie.aizerocode.langgraph4j.model.ImageCollectionPlan;
            ...
            try {
                ...
                if (plan.getDiagramTasks() != null) {
                    ...
                    for (ImageCollectionPlan.DiagramTask task : plan.getDiagramTasks()) {
                        futures.add(CompletableFuture.supplyAsync(() ->
                                diagramTool.generateArchitectureDiagram(task.mermaidCode(), task.description())));
                    }
                }
                // 并发执行Logo生成
