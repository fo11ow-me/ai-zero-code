...
import com.qiujie.aizerocode.langgraph4j.node.concurrent.*;
...
public class CodegenConcurrentWorkflow {
    ...
    public WorkflowContext executeWorkflow(String originalPrompt) {
        ...
        // 通过 RunnableConfig 为 fan-out 源节点注册 Executor，使分支真正并行执行
        RunnableConfig config = RunnableConfig.builder()
                .addParallelNodeExecutor("image_plan", Executors.newVirtualThreadPerTaskExecutor())
                .build();
